...
--
-- Table structure for table `subconsultant`
--

DROP TABLE IF EXISTS `subconsultant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `subconsultant` (
  `subconsultant_id` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`subconsultant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subconsultant`
--

LOCK TABLES `subconsultant` WRITE;
/*!40000 ALTER TABLE `subconsultant` DISABLE KEYS */;
/*!40000 ALTER TABLE `subconsultant` ENABLE KEYS */;
UNLOCK TABLES;
